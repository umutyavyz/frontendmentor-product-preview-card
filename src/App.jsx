          ...
          <div className="md:w-1/2 p-6 md:p-8 flex flex-col">
            ...
            <div className="space-y-2 md:space-y-4"> 
              ...
              <h1 className="text-2xl md:text-3xl leading-none font-bold font-fraunces text-gray-800">
                Gabrielle <br className="hidden md:block" /> Essence Eau <br className="hidden md:block" />De Parfum
              </h1>
              {/* Paragraf fontunu küçültür */}
              <p className="text-xs md:text-sm font-montserrat text-gray-500 leading-relaxed">
                A floral, solar and voluptuous interpretation composed by <br className="hidden md:block" /> Oliver
                Polge, Perfumer-Creator <br className="hidden md:block" /> for the House of CHANEL.
              </p>
            </div>
